...
# use weight to predict
python detect.py --weight=./data/yolov4.weights --tiny=Fasle --input_size=416 --model=yolov4 --img=./data/kite.jpg 

# use grpc api to predict
python detect-grpc.py --host=192.168.113.39:18500 --tiny=Fasle --input_size=416 --model=yolov4 --img=./data/kite.jpg 
```
## deploy model use tensorflow serving
```bash
sudo docker run -itd --rm \
    -p 18500:8500 -p 18501:8501 \
    -v $(pwd)/checkpoints/yolov4.tf:/models/yolov4/1 \
    -e 'MODEL_NAME=yolov4' \
